...
//
// ----------------------------------------------------------------------------------------
namespace EmberMemoryReader.Components.Collector.Readers.Windows
{
    public class SigScan
    {
        ...
        private ILogger<SigScan> Logger { get; }
        ...
        public SigScan(ILogger<SigScan> logger, Process proc)
        {
            this.Process = proc;
            this.Logger = logger;
        ...
        private void InitMemoryRegionInfo()
        {
            ...
            {
                Logger.LogError($"Error Code:0x{Marshal.GetLastWin32Error():X8}");
                return;
            }
            ...
            {
                Logger.LogError($"Error:List is Empty");
            }
        }
